...
$portfolio_cats = new portfolio_cats;
$list_portfolio_cats = $portfolio_cats->return_cat_list('projet');
$vc_add_css_animation = array(
	'type' => 'dropdown',
	'heading' => esc_html__( 'CSS Animation', 'locksmith' ),
	'param_name' => 'css_animation',
	'admin_label' => true,
	'value' => array(
		  esc_html__( 'No', 'locksmith' ) => '',
		  esc_html__('Bounce In', 'locksmith' ) => 'bounceIn',
          esc_html__('Bounce In Down', 'locksmith' ) => 'bounceInDown',
          esc_html__('Bounce In Left', 'locksmith' ) => 'bounceInLeft',
          esc_html__('Bounce In Right', 'locksmith' ) => 'bounceInRight',
          esc_html__('Bounce In Up', 'locksmith' ) => 'bounceInUp',
          esc_html__('Fade In', 'locksmith' ) => 'fadeIn',
          esc_html__('Fade In Down', 'locksmith' ) => 'fadeInDown',
          esc_html__('Fade In Down Big', 'locksmith' ) => 'fadeInDownBig',
          esc_html__('Fade In Left', 'locksmith' ) => 'fadeInLeft',
          esc_html__('Fade In Left Big', 'locksmith' ) => 'fadeInLeftBig',
          esc_html__('Fade In Right', 'locksmith' ) => 'fadeInRight',
          esc_html__('Fade In Right Big', 'locksmith' ) => 'fadeInRightBig',
          esc_html__('Fade In Up', 'locksmith' ) => 'fadeInUp',
          esc_html__('Fade In Up Big', 'locksmith' ) => 'fadeInUpBig',
          esc_html__('Flip', 'locksmith' ) => 'flip',
          esc_html__('Flip In X', 'locksmith' ) => 'flipInX',
          esc_html__('Flip In Y', 'locksmith' ) => 'flipInY',
          esc_html__('Flip Out X', 'locksmith' ) => 'flipOutX',
          esc_html__('Flip Out Y', 'locksmith' ) => 'flipOutY',
          esc_html__('Light Speed In', 'locksmith' ) => 'lightSpeedIn',
          esc_html__('Light Speed Out', 'locksmith' ) => 'lightSpeedOut',
          esc_html__('Rotate In', 'locksmith' ) => 'rotateIn',
          esc_html__('Rotate In Down Left', 'locksmith' ) => 'rotateInDownLeft',
          esc_html__('Rotate In Down Right', 'locksmith' ) => 'rotateInDownRight',
          esc_html__('Rotate In Up Left', 'locksmith' ) => 'rotateInUpLeft',
          esc_html__('Rotate In Up Right', 'locksmith' ) => 'rotateInUpRight',
          esc_html__('Slide In Up', 'locksmith' ) => 'slideInUp',
          esc_html__('Slide In Down', 'locksmith' ) => 'slideInDown',
          esc_html__('Slide In Left', 'locksmith' ) => 'slideInLeft',
          esc_html__('Slide In Right', 'locksmith' ) => 'slideInRight',
          esc_html__('Zoom In ', 'locksmith' ) => 'zoomIn',
          esc_html__('Zoom In Down', 'locksmith' ) => 'zoomInDown',
          esc_html__('Zoom In Left', 'locksmith' ) => 'zoomInLeft',
          esc_html__('Zoom In Right', 'locksmith' ) => 'zoomInRight',
          esc_html__('Zoom In Up', 'locksmith' ) => 'zoomInUp',
          esc_html__('Roll In', 'locksmith' ) => 'rollIn',
	),
	'description' => esc_html__( 'Select type of animation for element to be animated when it "enters" the browsers viewport (Note: works only in modern browsers).', 'locksmith' )
);
...
vc_add_param("vc_row",
	array(
		'type' => 'colorpicker',
		'heading' => esc_html__( 'Text Color', 'locksmith' ),
		'param_name' => 'font_color',
		'description' => esc_html__( 'Select font color', 'locksmith' ),
	)
);
...
vc_map( array(
    "name"            => esc_html__("locksmith_last_post", 'locksmith'), // add a name
...
---------------------------------------------------------- */
vc_map( array(
    "name" => esc_html__("Recent From Blog", 'locksmith'),
    "base" => "wd_blog",
  "category"=> esc_html__("Webdevia", 'locksmith'),
    ...
    "is_container" => FALSE,
     "params" => array(       
		    array(
            "type" => "textfield",
            "heading" => esc_html__("Items to display", 'locksmith'),
            "param_name" => "itemperpage",
        ),
        array(
            "type" => "textfield",
            "heading" => esc_html__("Columns To Display in mobile", 'locksmith'),
            "param_name" => "columns_mobile"
        ),
        array(
            "type" => "textfield",
            "heading" => esc_html__("Columns To Display in tablet", 'locksmith'),
            "param_name" => "columns_tablet"
        ),
        array(
            "type" => "textfield",
            "heading" => esc_html__("Columns To Display in desktop", 'locksmith'),
            "param_name" => "columns_desktop"
        ),
        array(
		     "type" => "checkbox",
		     "heading" => esc_html__("Display thumbnail", 'locksmith'),
		     "param_name" => "show_thumbnail",
		     "std" => "yes",
		     'value' => array( esc_html__( 'Yes, please', 'locksmith' ) => 'yes' ),
	  ),
...
---------------------------------------------------------- */
vc_map( array(
    "name" => esc_html__("Portfolio", 'locksmith'),
  ...
  "category"=> esc_html__("Webdevia", 'locksmith'),
    ...
    "params" => array(
        array(
            ...
            "heading" => esc_html__("Columns To Display in mobile", 'locksmith'),
            "param_name" => "columns_mobile",
            'description' => esc_html__( 'Used in Grid Layout', 'locksmith' ),
        ),
        array(
            "type" => "textfield",
            "heading" => esc_html__("Columns To Display in tablet", 'locksmith'),
        ...
        array(
            "type"       => "checkbox",
            "heading"    => esc_html__( "Categories", "locksmith" ),
            "param_name" => "locksmith_portfolio_categories",
            'value'      => $list_portfolio_cats,
        ),
        array(
            "type" => "textfield",
            "heading" => esc_html__("Items to display", 'locksmith'),
            "param_name" => "itemperpage",
            'description' => esc_html__( 'Used in Carousel Layout', 'locksmith' ),
        ),
		array(
...
---------------------------------------------------------- */
vc_map( array(
    "name" => esc_html__("Image Box", 'locksmith'),
  ...
  "category"=> esc_html__("Webdevia", 'locksmith'),
    ...
    "params" => array(
        ...
        array(
            "type" => "textarea",
            "heading" => esc_html__("Text", 'locksmith'),
            "param_name" => "text",
        ),
        array(
        ...
        array(
          ...
          'heading' => esc_html__( 'Layout', 'locksmith' ),
          'param_name' => 'layout',
          'value' => array('Layout 1 (title above image)' => 1, 'Layout 2 (title below image)' => 2),
          'description' => esc_html__( 'Select the box style.', 'locksmith' ),
          'admin_label' => true
        ),
        array(
            "type" => "vc_link",
            "heading" => esc_html__("URL to :", 'locksmith'),
            "param_name" => "url",
        ),
        array(
            "type" => "textfield",
...
---------------------------------------------------------- */
vc_map( array(
    "name" => esc_html__("Text Block With Icon", 'locksmith'),
    "base" => "wd_icon_text",
  "category"=> esc_html__("Webdevia", 'locksmith'),
    "content_element" => true,
    "is_container" => FALSE,
    "params" => array(
        ...
        array(
            "type" => "checkbox",
            "heading" => esc_html__("Display image instead of icon", 'locksmith'),
        ...
        array(
          'type' => 'dropdown',
          'heading' => esc_html__( 'Icon', 'locksmith' ),
          'param_name' => 'icon',
          'value' => $icons,
          'description' => esc_html__( 'Select the icon to use.', 'locksmith' ),
          'admin_label' => true
        ),
        array(
          'type' => 'dropdown',
          ...
          'admin_label' => true
		    ...
		    array(
			    "type" => "vc_link",
			    "heading" => esc_html__("Link URL", 'locksmith'),
...
---------------------------------------------------------- */
  vc_map( array(
    "name" => esc_html__("Testimonial", 'locksmith'), // add a name
    ...
    "params" => array( 
        ...
        array(
            "type" => "textfield",
            "heading" => esc_html__("Maximum Number Of Items To Show", 'locksmith'),
            "param_name" => "itemperpage",
        ),
        $vc_add_css_animation
    )
...
---------------------------------------------------------- */
vc_map( array(
    "name" => esc_html__("Carousel Client", 'locksmith'),
    "base" => "wd_client",
  "category"=> esc_html__("Webdevia", 'locksmith'),
    "content_element" => true, 
    "is_container" => FALSE,
    "params" => array(         
          array(
               'type' => 'attach_images',
               'heading' => esc_html__( 'Images', 'locksmith' ),
               'param_name' => 'images',
               
          ),array(
            "type" => "dropdown",
            "heading" => esc_html__("Columns", 'locksmith'),
            "param_name" => "columns",
...
---------------------------------------------------------- */
vc_map( array(
    "name" => esc_html__("Wd Separator Title", 'locksmith'),
  ...
  "category"=> esc_html__("Webdevia", 'locksmith'),
    ...
    "params" => array(         
        ...
        'type' => 'dropdown',
        'param_name' => 'wd_separator_layout',
        'value' => array(
          __( 'Layout 1', 'locksmith' ) => 'wd-layout_1',
          __( 'Layout 2', 'locksmith' ) => 'wd-layout_2'
        ),
        'heading' => __( 'Wd Separator Layout', 'locksmith' )
      ),
      array(
        "type" => "colorpicker",
        "param_name" => "wd_separator_title_color",
        "holder"     => "div",
        "heading"      => "Choose Title Color ",
        "description"      => "Choose color ",
        "dependency" => Array("element" => "wd_separator_layout", "value" => array('wd-layout_2'))
      ),
      array(
        "type" => "colorpicker",
        "param_name" => "wd_separator_sub_title_color",
        "holder"     => "div",
        "heading"      => "Choose Sub Title Color ",
        "description"      => "Choose color ",
        "dependency" => Array("element" => "wd_separator_layout", "value" => array('wd-layout_2'))
      ),array(
          'type' => 'dropdown',
          ...
          'value' => array(
            __( 'Center', 'locksmith' ) => 'wd-title-section_c',
            __( 'Left', 'locksmith' ) => 'wd-title-section_l'
          ),
          'heading' => __( 'Wd Separator title Align', 'locksmith' )
        ),
        $vc_add_css_animation
    )
) );
...
---------------------------------------------------------- */
vc_map( array(
    "name" => esc_html__("Count Up", 'locksmith'),
    "base" => "wd_count_up",
  "category"=> esc_html__("Webdevia", 'locksmith'),
    "content_element" => true, 
    "is_container" => FALSE,
    "params" => array( 
        ...
        array(
            "type" => "textfield",
            "heading" => esc_html__("Countto (number)", 'locksmith'),
            "param_name" => "countto",
        ),
        array(
            "type" => "textfield",
            "heading" => esc_html__("time (in seconds, only number)", 'locksmith'),
            "param_name" => "time",
        ),
        array(
            "type" => "colorpicker",
            "heading" => esc_html__("Color", 'locksmith'),
...
---------------------------------------------------------- */
vc_map( array(
    "name" => esc_html__("Wd Slider", 'locksmith'),
    "base" => "wd_slider",
  "category"=> esc_html__("Webdevia", 'locksmith'),
    "content_element" => true, 
    "is_container" => FALSE,
    "params" => array( 
        array(
          'type' => 'dropdown',
          'param_name' => 'locksmith_slider_layout',
          'value' => array(
            __( 'Large Layout', 'locksmith' ) => 'large',
            __( 'Fullscreen Layout', 'locksmith' ) => 'fullscreen'
          )
        ),
    )
) );
...
---------------------------------------------------------- */
  vc_map( array(
    "name" => esc_html__("Team", 'locksmith'), // add a name
    ...
    "params" => array( 
        ...
        array(
            "type" => "textfield",
            "heading" => esc_html__("Items Per Page", 'locksmith'),
            "param_name" => "itemperpage",
        ),
        array(
             "type" => "checkbox",
             "heading" => esc_html__("Display column gutters", 'locksmith'),
        ...
        array(
             "type" => "checkbox",
             "heading" => esc_html__("Display team members description", 'locksmith'),
...
vc_add_param("vc_tta_accordion",
        array(
          'type' => 'dropdown',
          'param_name' => 'locksmith_accordion_style',
          'value' => array(
            __( ' ', 'locksmith' ) => '',
            __( 'Style 1', 'locksmith' ) => 'locksmith_accordion_style_d',
            __( 'Style 2', 'locksmith' ) => 'locksmith_accordion_style_l'
          ),
          'heading' => __( 'Use Wd Accordion Style', 'locksmith' )
        )
);
...
---------------------------------------------------------- */
vc_map( array(
    "name" => esc_html__("Wd Call To Action", 'locksmith'),
  ...
  "category"=> esc_html__("Webdevia", 'locksmith'),
    ...
    "params" => array(
        ...
        array(
            "type" => "vc_link",
            "heading" => esc_html__("Button URL", 'locksmith'),
